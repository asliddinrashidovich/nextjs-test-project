    ...
    <div className=' bg-[#e8e8e8] w-full px-[30px] py-[10px] border-b-[1px] border-[#999] fixed z-99'>
        <div className='flex justify-between  items-center max-w-[1300px] mx-auto'>
            ...
            <ul className='flex gap-[20px] items-center'>
                <Link href={'/addproduct'} className='flex gap-[5px] relative overflow-hidden items-center px-[25px] py-[5px] text-[15px] text-white bg-[#00b7ff] rounded-[5px] cursor-pointer'>
                    <span className='text-[17px]'>Add New Product</span> 
                </Link>
