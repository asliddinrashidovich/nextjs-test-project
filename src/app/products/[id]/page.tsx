...
async function ProductDetails({params}: {params: {id: string}}) {
  ...
  return (
    <div className='max-w-[1300px] mx-auto px-[30px]  pt-[100px] min-h-[100vh]'>
        ...
        <div className='w-full py-[40px] px-[40px] gap-[40px] flex bg-[#fff] border-[1px] border-[#999] rounded-[10px] mt-[30px]'>
            <div className='min-w-[40%] max-w-[40%] overflow-hidden flex justify-center'>
                <Image src={product.image} alt={product.title} style={{objectFit: 'cover'}} width={1500} height={100}/>
            </div>
            <div>
